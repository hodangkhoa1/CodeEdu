...
const htmlData = r"""
  <section>
    <div class="en section_container active" section-language="en">
      <div data-target="out_en" class="agreement_md">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Code Edu
            </p>
          </li>
          <li>
            <p>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Code Edu.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            By email: hodangkhoa110701@gmail.com
          </li>
        </ul>
      </div>
    </div>
